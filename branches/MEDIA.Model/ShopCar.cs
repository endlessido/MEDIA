...
namespace MEDIA.Model
{
    ...
    public partial class ShopCar: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int CarId
        {
            ...
            set
            {
                if (_carId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'CarId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _carId = value;
        ...
        private void FixupProduct(Product previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.ShopCars.Contains(this))
            {
                previousValue.ShopCars.Remove(this);
            }
    
            if (Product != null)
            {
                if (!Product.ShopCars.Contains(this))
                {
                    Product.ShopCars.Add(this);
                }
