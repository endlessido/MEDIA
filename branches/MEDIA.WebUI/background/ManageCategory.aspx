<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCategory.aspx.cs" Inherits="MEDIA.WebUI.background.ManageCategory" %>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-header">
    <div class="page-header-content">
        <h2>Sport Category Management</h2>
    </div>
</div>
        ...
        <div class="page-dashboard clearfix">
            <div class="page-mngregion span5 border-color-blue">
                ...
                <ul><li class="page-nwfm">
                    ...
                    <ItemTemplate>
                    <li id="<%# Eval("CategoryId") %>"><a href="#" class="fg-color-darken"><%# Eval("CategoryName")%></a> 
                    <a href="#" class="fr page-del fg-color-red"><i class="icon-cancel-2"></i></a>
                    <a href="#" class="fr page-edr"><i class="icon-pencil"></i></a></li>
                    </ItemTemplate>
                    </asp:Repeater>
