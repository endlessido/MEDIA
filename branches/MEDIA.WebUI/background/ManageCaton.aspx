<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCaton.aspx.cs" Inherits="MEDIA.WebUI.background.ManageCaton" %>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-region bg-color-white">
    <div class="page-region-content">
        <div class="page-dashboard clearfix">
            <div class="page-mngregion span5 border-color-blue">
                ...
                <ul><li class="page-nwfm">
                    ...
                    <a href="#" class="fr page-del fg-color-red"><i class="icon-cancel-2"></i></a>
                     <a href="#" class="fr page-edr"><i class="icon-pencil"></i></a></li>
                    <asp:Repeater ID="RepArea" runat="server">
                    <ItemTemplate>
                    <li id="<%# Eval("AreaId") %>"><a href="#" class="fg-color-darken"><%# Eval("AreaName")%></a> 
                    <a href="#" class="fr page-del fg-color-red"><i class="icon-cancel-2"></i></a> 
                    <a href="#" class="fr page-edr"><i class="icon-pencil"></i></a> </li>
                    </ItemTemplate>
                    </asp:Repeater>
            ...
            <p class="tlr span5"><asp:Button ID="Button1"  runat="server" Text="Submit" OnClick="BtnSubmit_Click"/></p>
        </div>
    </div>
</div>
</form>
